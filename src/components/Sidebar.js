...
const Sidebar = () => {
  ...
  return (
  <div className={`w-full bg-white fixed ${isOpen? 'right-0' : '-right-full'}
    ...
    <div className='flex flex-col gap-y-2
      h-[410px] lg:h-[410px] overflow-y-auto overflow-x-hidden
      border-b'>
        {cart.map(item => {
    ...
    <div className='flex flex-col gap-y-3
      ...
      <div className='flex w-full justify-between
        ...
        <div onClick={clearCart} className='cursor-pointer py-4 bg-red-500 
          text-white w-12 h-12 flex justify-center text-xl'>
          <FiTrash2/>
        </div>
        </div>
